...
class pfc2d:
    ...
    def _initFields(self):
        ...
        if self.pfcParms.ntype == 1:
            ...
            # add noise...
            # ...but first, get the FFT w/o noise
            nAk0 = cp.fft.fft2(self.pfcData.nA)
            nBk0 = cp.fft.fft2(self.pfcData.nB)
            nA10 = cp.fft.fft2(self.pfcData.A1)
            nA20 = cp.fft.fft2(self.pfcData.A2)
            nA30 = cp.fft.fft2(self.pfcData.A3)
            nB10 = cp.fft.fft2(self.pfcData.B1)
            nB20 = cp.fft.fft2(self.pfcData.B2)
            nB30 = cp.fft.fft2(self.pfcData.B3)
            ...
            self.pfcData.nA += self.pfcParms.noise * ((-0.26822407 - -0.443516463) * (cp.random.rand(Lx, Ly) * 2 - 1))
            self.pfcData.nB += self.pfcParms.noise * ((-0.26822407 - -0.443516463) * (cp.random.rand(Lx, Ly) * 2 - 1))

            # now, keep the 0th mode the same
            nAk1 = cp.fft.fft2(self.pfcData.nA)
            nBk1 = cp.fft.fft2(self.pfcData.nB)
            nA11 = cp.fft.fft2(self.pfcData.A1)
            nA21 = cp.fft.fft2(self.pfcData.A2)
            nA31 = cp.fft.fft2(self.pfcData.A3)
            nB11 = cp.fft.fft2(self.pfcData.B1)
            nB21 = cp.fft.fft2(self.pfcData.B2)
            nB31 = cp.fft.fft2(self.pfcData.B3)
            ...
            self.pfcData.nA = cp.fft.ifft2(nAk1).real
            self.pfcData.nB = cp.fft.ifft2(nBk1).real
            self.pfcData.A1 = cp.fft.ifft2(nA11)
            self.pfcData.A2 = cp.fft.ifft2(nA21)
            self.pfcData.A3 = cp.fft.ifft2(nA31)
            self.pfcData.B1 = cp.fft.ifft2(nB11)
            self.pfcData.B2 = cp.fft.ifft2(nB21)
            self.pfcData.B3 = cp.fft.ifft2(nB31)
        ...
        for i in range(steps + 1)[1:]:
            ...
            if saveEvery is not None and i % saveEvery == 0:
                ...
                np.savez_compressed(os.path.join(outputFolder, f"t_{self.pfcData.t + i * self.pfcParms.dt:.5f}.npz"),
                    ...
                    energy = self.pfcData.eng.mean(),
                    gamma = self.pfcData.gamma,
